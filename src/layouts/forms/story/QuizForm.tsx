...
const quizzes = [
	{
		questionId: 'q1',
		question: 'What is the moral lesson of the story neds nem,sdi, umoerie saesdne. Mata ne ototo desu yo animore san sonku kare wa joudan desu. Hajime ta ka ni yo amiyanai desuka?',
