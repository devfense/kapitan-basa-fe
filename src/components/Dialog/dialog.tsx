...
const Badge = styled.div`
	...
	@keyframes blinkingBackground {
		0% {
			background-color: ${({ theme }) => theme.app.brand.normal.BG_COLOR};
		}
		25% {
			background-color: ${({ theme }) => theme.app.brand.normal.SECONDARY_BG_COLOR};
		}
		50% {
			background-color: ${({ theme }) => theme.app.brand.normal.BG_COLOR};
		}
...
const DialogActionButton = (props: DialogActionProps) => {
	...
	return (
		<StyledDialogContentActions {...other}>
			<Button shade="filled">{children}</Button>
...
export const DialogContentContainer: FunctionComponent<DialogContainerProps> = ({
	title,
	submitText,
	children,
	onClose,
