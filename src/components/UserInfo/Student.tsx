    ...
    return (
        <div>
            <TextBox> 
                ...
                <TextLabel>{`${userInfo.firstName} ${userInfo.middleName} ${userInfo.lastName}`}</TextLabel>
            </TextBox>
            <TextBox> 
                <Placeholder>{ strings.studID }</Placeholder>
                <TextLabel>{ userInfo.studentID }</TextLabel>
            </TextBox>
            <TextBox> 
                <Placeholder>{ strings.gradeSection }</Placeholder>
                <TextLabel>{`${userInfo.grade} / ${userInfo.section}`}</TextLabel>
            </TextBox>
            <TextBox> 
